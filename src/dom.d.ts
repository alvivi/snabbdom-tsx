...
// This file is based on (MIT License):
// https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/react/react.d.ts
// By: Asana <https://asana.com>, AssureSign <http://www.assuresign.com>,
//     Microsoft <https://microsoft.com> and
...
declare namespace Snabbdom {
  ...
  type SyntheticEventHandler = EventHandler<SyntheticEvent>;
  ...
  interface HTMLProps<T extends Element> extends HTMLAttributes, VNode<T> {
  }

  interface SVGProps<T extends Element> extends SVGAttributes, VNode<T> {
  }
  ...
  interface DOMAttributes {
    ...
    // Image Events
    onLoad?: SyntheticEventHandler;
    onError?: SyntheticEventHandler; // also a Media Event
    ...
    // Media Events
    onAbort?: SyntheticEventHandler;
    onCanPlay?: SyntheticEventHandler;
    onCanPlayThrough?: SyntheticEventHandler;
    onDurationChange?: SyntheticEventHandler;
    onEmptied?: SyntheticEventHandler;
    onEncrypted?: SyntheticEventHandler;
    onEnded?: SyntheticEventHandler;
    onLoadedData?: SyntheticEventHandler;
    onLoadedMetadata?: SyntheticEventHandler;
    onLoadStart?: SyntheticEventHandler;
    onPause?: SyntheticEventHandler;
    onPlay?: SyntheticEventHandler;
    onPlaying?: SyntheticEventHandler;
    onProgress?: SyntheticEventHandler;
    onRateChange?: SyntheticEventHandler;
    onSeeked?: SyntheticEventHandler;
    onSeeking?: SyntheticEventHandler;
    onStalled?: SyntheticEventHandler;
    onSuspend?: SyntheticEventHandler;
    onTimeUpdate?: SyntheticEventHandler;
    onVolumeChange?: SyntheticEventHandler;
    onWaiting?: SyntheticEventHandler;
    ...
    // Selection Events
    onSelect?: SyntheticEventHandler;
...
declare namespace JSX {
  ...
  interface IntrinsicElements {
    // HTML
    a: Snabbdom.HTMLProps<HTMLAnchorElement>;
    abbr: Snabbdom.HTMLProps<HTMLElement>;
    address: Snabbdom.HTMLProps<HTMLElement>;
    area: Snabbdom.HTMLProps<HTMLAreaElement>;
    article: Snabbdom.HTMLProps<HTMLElement>;
    aside: Snabbdom.HTMLProps<HTMLElement>;
    audio: Snabbdom.HTMLProps<HTMLAudioElement>;
    b: Snabbdom.HTMLProps<HTMLElement>;
    base: Snabbdom.HTMLProps<HTMLBaseElement>;
    bdi: Snabbdom.HTMLProps<HTMLElement>;
    bdo: Snabbdom.HTMLProps<HTMLElement>;
    big: Snabbdom.HTMLProps<HTMLElement>;
    blockquote: Snabbdom.HTMLProps<HTMLElement>;
    body: Snabbdom.HTMLProps<HTMLBodyElement>;
    br: Snabbdom.HTMLProps<HTMLBRElement>;
    button: Snabbdom.HTMLProps<HTMLButtonElement>;
    canvas: Snabbdom.HTMLProps<HTMLCanvasElement>;
    caption: Snabbdom.HTMLProps<HTMLElement>;
    cite: Snabbdom.HTMLProps<HTMLElement>;
    code: Snabbdom.HTMLProps<HTMLElement>;
    col: Snabbdom.HTMLProps<HTMLTableColElement>;
    colgroup: Snabbdom.HTMLProps<HTMLTableColElement>;
    data: Snabbdom.HTMLProps<HTMLElement>;
    datalist: Snabbdom.HTMLProps<HTMLDataListElement>;
    dd: Snabbdom.HTMLProps<HTMLElement>;
    del: Snabbdom.HTMLProps<HTMLElement>;
    details: Snabbdom.HTMLProps<HTMLElement>;
    dfn: Snabbdom.HTMLProps<HTMLElement>;
    dialog: Snabbdom.HTMLProps<HTMLElement>;
    div: Snabbdom.HTMLProps<HTMLDivElement>;
    dl: Snabbdom.HTMLProps<HTMLDListElement>;
    dt: Snabbdom.HTMLProps<HTMLElement>;
    em: Snabbdom.HTMLProps<HTMLElement>;
    embed: Snabbdom.HTMLProps<HTMLEmbedElement>;
    fieldset: Snabbdom.HTMLProps<HTMLFieldSetElement>;
    figcaption: Snabbdom.HTMLProps<HTMLElement>;
    figure: Snabbdom.HTMLProps<HTMLElement>;
    footer: Snabbdom.HTMLProps<HTMLElement>;
    form: Snabbdom.HTMLProps<HTMLFormElement>;
    h1: Snabbdom.HTMLProps<HTMLHeadingElement>;
    h2: Snabbdom.HTMLProps<HTMLHeadingElement>;
    h3: Snabbdom.HTMLProps<HTMLHeadingElement>;
    h4: Snabbdom.HTMLProps<HTMLHeadingElement>;
    h5: Snabbdom.HTMLProps<HTMLHeadingElement>;
    h6: Snabbdom.HTMLProps<HTMLHeadingElement>;
    head: Snabbdom.HTMLProps<HTMLHeadElement>;
    header: Snabbdom.HTMLProps<HTMLElement>;
    hgroup: Snabbdom.HTMLProps<HTMLElement>;
    hr: Snabbdom.HTMLProps<HTMLHRElement>;
    html: Snabbdom.HTMLProps<HTMLHtmlElement>;
    i: Snabbdom.HTMLProps<HTMLElement>;
    iframe: Snabbdom.HTMLProps<HTMLIFrameElement>;
    img: Snabbdom.HTMLProps<HTMLImageElement>;
    input: Snabbdom.HTMLProps<HTMLInputElement>;
    ins: Snabbdom.HTMLProps<HTMLModElement>;
    kbd: Snabbdom.HTMLProps<HTMLElement>;
    keygen: Snabbdom.HTMLProps<HTMLElement>;
    label: Snabbdom.HTMLProps<HTMLLabelElement>;
    legend: Snabbdom.HTMLProps<HTMLLegendElement>;
    li: Snabbdom.HTMLProps<HTMLLIElement>;
    link: Snabbdom.HTMLProps<HTMLLinkElement>;
    main: Snabbdom.HTMLProps<HTMLElement>;
    map: Snabbdom.HTMLProps<HTMLMapElement>;
    mark: Snabbdom.HTMLProps<HTMLElement>;
    menu: Snabbdom.HTMLProps<HTMLElement>;
    menuitem: Snabbdom.HTMLProps<HTMLElement>;
    meta: Snabbdom.HTMLProps<HTMLMetaElement>;
    meter: Snabbdom.HTMLProps<HTMLElement>;
    nav: Snabbdom.HTMLProps<HTMLElement>;
    noscript: Snabbdom.HTMLProps<HTMLElement>;
    object: Snabbdom.HTMLProps<HTMLObjectElement>;
    ol: Snabbdom.HTMLProps<HTMLOListElement>;
    optgroup: Snabbdom.HTMLProps<HTMLOptGroupElement>;
    option: Snabbdom.HTMLProps<HTMLOptionElement>;
    output: Snabbdom.HTMLProps<HTMLElement>;
    p: Snabbdom.HTMLProps<HTMLParagraphElement>;
    param: Snabbdom.HTMLProps<HTMLParamElement>;
    picture: Snabbdom.HTMLProps<HTMLElement>;
    pre: Snabbdom.HTMLProps<HTMLPreElement>;
    progress: Snabbdom.HTMLProps<HTMLProgressElement>;
    q: Snabbdom.HTMLProps<HTMLQuoteElement>;
    rp: Snabbdom.HTMLProps<HTMLElement>;
    rt: Snabbdom.HTMLProps<HTMLElement>;
    ruby: Snabbdom.HTMLProps<HTMLElement>;
    s: Snabbdom.HTMLProps<HTMLElement>;
    samp: Snabbdom.HTMLProps<HTMLElement>;
    script: Snabbdom.HTMLProps<HTMLElement>;
    section: Snabbdom.HTMLProps<HTMLElement>;
    select: Snabbdom.HTMLProps<HTMLSelectElement>;
    small: Snabbdom.HTMLProps<HTMLElement>;
    source: Snabbdom.HTMLProps<HTMLSourceElement>;
    span: Snabbdom.HTMLProps<HTMLSpanElement>;
    strong: Snabbdom.HTMLProps<HTMLElement>;
    style: Snabbdom.HTMLProps<HTMLStyleElement>;
    sub: Snabbdom.HTMLProps<HTMLElement>;
    summary: Snabbdom.HTMLProps<HTMLElement>;
    sup: Snabbdom.HTMLProps<HTMLElement>;
    table: Snabbdom.HTMLProps<HTMLTableElement>;
    tbody: Snabbdom.HTMLProps<HTMLTableSectionElement>;
    td: Snabbdom.HTMLProps<HTMLTableDataCellElement>;
    textarea: Snabbdom.HTMLProps<HTMLTextAreaElement>;
    tfoot: Snabbdom.HTMLProps<HTMLTableSectionElement>;
    th: Snabbdom.HTMLProps<HTMLTableHeaderCellElement>;
    thead: Snabbdom.HTMLProps<HTMLTableSectionElement>;
    time: Snabbdom.HTMLProps<HTMLElement>;
    title: Snabbdom.HTMLProps<HTMLTitleElement>;
    tr: Snabbdom.HTMLProps<HTMLTableRowElement>;
    track: Snabbdom.HTMLProps<HTMLTrackElement>;
    u: Snabbdom.HTMLProps<HTMLElement>;
    ul: Snabbdom.HTMLProps<HTMLUListElement>;
    'var': Snabbdom.HTMLProps<HTMLElement>;
    video: Snabbdom.HTMLProps<HTMLVideoElement>;
    wbr: Snabbdom.HTMLProps<HTMLElement>;

    // SVG
    svg: Snabbdom.SVGProps<SVGElement>;
    circle: Snabbdom.SVGProps<SVGCircleElement>;
    clipPath: Snabbdom.SVGProps<SVGClipPathElement>;
    defs: Snabbdom.SVGProps<SVGDefsElement>;
    desc: Snabbdom.SVGProps<SVGDescElement>;
    ellipse: Snabbdom.SVGProps<SVGEllipseElement>;
    feBlend: Snabbdom.SVGProps<SVGFEBlendElement>;
    feColorMatrix: Snabbdom.SVGProps<SVGFEColorMatrixElement>;
    feComponentTransfer: Snabbdom.SVGProps<SVGFEComponentTransferElement>;
    feComposite: Snabbdom.SVGProps<SVGFECompositeElement>;
    feConvolveMatrix: Snabbdom.SVGProps<SVGFEConvolveMatrixElement>;
    feDiffuseLighting: Snabbdom.SVGProps<SVGFEDiffuseLightingElement>;
    feDisplacementMap: Snabbdom.SVGProps<SVGFEDisplacementMapElement>;
    feDistantLight: Snabbdom.SVGProps<SVGFEDistantLightElement>;
    feFlood: Snabbdom.SVGProps<SVGFEFloodElement>;
    feFuncA: Snabbdom.SVGProps<SVGFEFuncAElement>;
    feFuncB: Snabbdom.SVGProps<SVGFEFuncBElement>;
    feFuncG: Snabbdom.SVGProps<SVGFEFuncGElement>;
    feFuncR: Snabbdom.SVGProps<SVGFEFuncRElement>;
    feGaussianBlur: Snabbdom.SVGProps<SVGFEGaussianBlurElement>;
    feImage: Snabbdom.SVGProps<SVGFEImageElement>;
    feMerge: Snabbdom.SVGProps<SVGFEMergeElement>;
    feMergeNode: Snabbdom.SVGProps<SVGFEMergeNodeElement>;
    feMorphology: Snabbdom.SVGProps<SVGFEMorphologyElement>;
    feOffset: Snabbdom.SVGProps<SVGFEOffsetElement>;
    fePointLight: Snabbdom.SVGProps<SVGFEPointLightElement>;
    feSpecularLighting: Snabbdom.SVGProps<SVGFESpecularLightingElement>;
    feSpotLight: Snabbdom.SVGProps<SVGFESpotLightElement>;
    feTile: Snabbdom.SVGProps<SVGFETileElement>;
    feTurbulence: Snabbdom.SVGProps<SVGFETurbulenceElement>;
    filter: Snabbdom.SVGProps<SVGFilterElement>;
    foreignObject: Snabbdom.SVGProps<SVGForeignObjectElement>;
    g: Snabbdom.SVGProps<SVGGElement>;
    image: Snabbdom.SVGProps<SVGImageElement>;
    line: Snabbdom.SVGProps<SVGLineElement>;
    linearGradient: Snabbdom.SVGProps<SVGLinearGradientElement>;
    marker: Snabbdom.SVGProps<SVGMarkerElement>;
    mask: Snabbdom.SVGProps<SVGMaskElement>;
    metadata: Snabbdom.SVGProps<SVGMetadataElement>;
    path: Snabbdom.SVGProps<SVGPathElement>;
    pattern: Snabbdom.SVGProps<SVGPatternElement>;
    polygon: Snabbdom.SVGProps<SVGPolygonElement>;
    polyline: Snabbdom.SVGProps<SVGPolylineElement>;
    radialGradient: Snabbdom.SVGProps<SVGRadialGradientElement>;
    rect: Snabbdom.SVGProps<SVGRectElement>;
    stop: Snabbdom.SVGProps<SVGStopElement>;
    switch: Snabbdom.SVGProps<SVGSwitchElement>;
    symbol: Snabbdom.SVGProps<SVGSymbolElement>;
    text: Snabbdom.SVGProps<SVGTextElement>;
    textPath: Snabbdom.SVGProps<SVGTextPathElement>;
    tspan: Snabbdom.SVGProps<SVGTSpanElement>;
    use: Snabbdom.SVGProps<SVGUseElement>;
    view: Snabbdom.SVGProps<SVGViewElement>;
  }
}
